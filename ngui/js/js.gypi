		...
		'actions': [
			{
				...
				'inputs': [
					...
					'../../libs/ngui/_action.ts',
					'../../libs/ngui/_common.ts',
					'../../libs/ngui/_event.ts',
					'../../libs/ngui/_ext.ts',
					'../../libs/ngui/_path.ts',
					'../../libs/ngui/_pkgutil.ts',
					'../../libs/ngui/_util.ts',
					'../../libs/ngui/_view.ts',
					'../../libs/ngui/action.ts',
					'../../libs/ngui/app.ts',
					'../../libs/ngui/buffer.ts',
					'../../libs/ngui/checkbox.tsx',
					'../../libs/ngui/css.ts',
					'../../libs/ngui/ctr.ts',
					'../../libs/ngui/dialog.tsx',
					'../../libs/ngui/display_port.ts',
					'../../libs/ngui/event.ts',
					'../../libs/ngui/font.ts',
					'../../libs/ngui/fs.ts',
					'../../libs/ngui/http.ts',
					'../../libs/ngui/media.ts',
					'../../libs/ngui/nav.tsx',
					'../../libs/ngui/overlay.tsx',
					'../../libs/ngui/package.json',
					'../../libs/ngui/path.ts',
					'../../libs/ngui/pkg.ts',
					'../../libs/ngui/index.ts',
					'../../libs/ngui/reader.ts',
					'../../libs/ngui/stepper.tsx',
					'../../libs/ngui/storage.ts',
					'../../libs/ngui/sys.ts',
					'../../libs/ngui/timer.ts',
					'../../libs/ngui/util.ts',
					'../../libs/ngui/value.ts',
