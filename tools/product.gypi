			...
			['os=="ios"', {
				...
				'link_settings': {
					'libraries': [
						...
						'<(DEPTH)/out/libs/ios/Frameworks/$(PLATFORM_NAME)/$(CONFIGURATION)/nxmedia.framework',
						'<(DEPTH)/out/libs/ios/Frameworks/$(PLATFORM_NAME)/$(CONFIGURATION)/nxv8.framework',
						'<(DEPTH)/out/libs/ios/Frameworks/$(PLATFORM_NAME)/$(CONFIGURATION)/nxjs.framework',
						'<(DEPTH)/out/libs/ios/Frameworks/$(PLATFORM_NAME)/$(CONFIGURATION)/nxnode.framework',
					],
				},
				'mac_framework_dirs': [
