...
cp -rf nimake/product/include linux-ubuntu.x64.Release.shared
...
cp -rf nimake/product/include linux-ubuntu.armv7.Release.shared
...
cp -rf nimake/product/include linux-ubuntu.x64.Release
...
cp -rf nimake/product/include linux-ubuntu.armv7.Release
