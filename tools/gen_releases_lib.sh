...
cp -rf nxmake/product/include linux-ubuntu.x64.Release.shared
...
cp -rf nxmake/product/include linux-ubuntu.armv7.Release.shared
...
cp -rf nxmake/product/include linux-ubuntu.x64.Release
...
cp -rf nxmake/product/include linux-ubuntu.armv7.Release
