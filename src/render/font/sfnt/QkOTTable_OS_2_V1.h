...
struct QkOTTableOS2_V1 {
	Qk_OT_USHORT version;
	static const Qk_OT_USHORT VERSION = QkEndian_SwapBE16(1);
	...
	union UnicodeRange {
		...
		struct Raw {
			struct l0 {
				...
				static const Qk_OT_ULONG BasicGreekMask = QkOTSetULONGBit<7>::value;
				static const Qk_OT_ULONG GreekSymbolsAndCCopticMask = QkOTSetULONGBit<8>::value;
				...
				static const Qk_OT_ULONG BasicHebrewMask = QkOTSetULONGBit<11>::value;
				static const Qk_OT_ULONG HebrewExtendedABMask = QkOTSetULONGBit<12>::value;
				static const Qk_OT_ULONG BasicArabicMask = QkOTSetULONGBit<13>::value;
				static const Qk_OT_ULONG ArabicExtendedMask = QkOTSetULONGBit<14>::value;
				...
				static const Qk_OT_ULONG BasicGeorgianMask = QkOTSetULONGBit<26>::value;
				static const Qk_OT_ULONG GeorgianExtendedMask = QkOTSetULONGBit<27>::value;
...
static_assert(sizeof(QkOTTableOS2_V1) == 86, "sizeof_QkOTTableOS2_V1_not_86");
