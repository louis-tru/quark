...
#ifndef QkOTTable_OS_2_V3_DEFINED
#define QkOTTable_OS_2_V3_DEFINED
...
struct QkOTTableOS2_V3 {
	Qk_OT_USHORT version;
	static const Qk_OT_USHORT VERSION = QkEndian_SwapBE16(3);
...
static_assert(sizeof(QkOTTableOS2_V3) == 96, "sizeof_QkOTTableOS2_V3_not_96");
