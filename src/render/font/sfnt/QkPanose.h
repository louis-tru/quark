...
struct QkPanose {
	...
	enum class FamilyType : Qk_OT_BYTE {
		Any = 0,
		NoFit = 1,
		TextAndDisplay = 2,
		Script = 3,
	...
	union Data {
		struct TextAndDisplay {
			enum class SerifStyle : Qk_OT_BYTE {
				Any = 0,
				NoFit = 1,
				Cove = 2,
				ObtuseCove = 3,
			...
			enum class Proportion : Qk_OT_BYTE {
				Any = 0,
				NoFit = 1,
				OldStyle = 2,
				Modern = 3,
			...
			enum class Contrast : Qk_OT_BYTE {
				Any = 0,
				NoFit = 1,
				None = 2,
				VeryLow = 3,
			...
			enum class ArmStyle : Qk_OT_BYTE {
				Any = 0,
				NoFit = 1,
			...
			enum class Letterform : Qk_OT_BYTE {
				Any = 0,
				NoFit = 1,
				Normal_Contact = 2,
				Normal_Weighted = 3,
		...
		struct Script {
			enum class ToolKind : Qk_OT_BYTE {
				Any = 0,
				NoFit = 1,
				FlatNib = 2,
				PressurePoint = 3,
			...
			enum class AspectRatio : Qk_OT_BYTE {
				Any = 0,
				NoFit = 1,
				VeryCondensed = 2,
				Condensed = 3,
			...
			enum class Topology : Qk_OT_BYTE {
				Any = 0,
				NoFit = 1,
		...
		struct Decorative {
			...
			enum class SerifVariant : Qk_OT_BYTE {
				Any = 0,
				NoFit = 1,
				Cove = 2,
				ObtuseCove = 3,
			...
			enum class Treatment : Qk_OT_BYTE {
				Any = 0,
				NoFit = 1,
			...
			enum class RangeOfCharacters : Qk_OT_BYTE {
				Any = 0,
				NoFit = 1,
		...
		struct Pictoral {
			...
			enum class AspectRatioAndContrast : Qk_OT_BYTE {
				NoFit = 1,
			} bAspectRatioAndContrast;

			enum class AspectRatio94 : Qk_OT_BYTE {
				Any = 0,
				NoFit = 1,
				NoWidth = 2,
				ExceptionallyWide = 3,
			...
			enum class AspectRatio119 : Qk_OT_BYTE {
				Any = 0,
				NoFit = 1,
				NoWidth = 2,
				ExceptionallyWide = 3,
			 ...
			 enum class AspectRatio157 : Qk_OT_BYTE {
				Any = 0,
				NoFit = 1,
				NoWidth = 2,
				ExceptionallyWide = 3,
			...
			enum class AspectRatio163 : Qk_OT_BYTE {
				Any = 0,
				NoFit = 1,
				NoWidth = 2,
				ExceptionallyWide = 3,
