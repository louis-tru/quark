		...
		'actions': [
			...
			},
			{
				...
				'inputs': [
					...
					'render/gl/glsl/color_normal.frag.glsl',
					'render/gl/glsl/color_normal.vert.glsl',
					'render/gl/glsl/color_mask.frag.glsl',
					'render/gl/glsl/color_mask.vert.glsl',
					'render/gl/glsl/color_dotted.frag.glsl',
					'render/gl/glsl/color_dotted.vert.glsl',
					'render/gl/glsl/color_linear.frag.glsl',
					'render/gl/glsl/color_linear.vert.glsl',
					'render/gl/glsl/color_radial.frag.glsl',
					'render/gl/glsl/color_radial.vert.glsl',
					'render/gl/glsl/color_sdf.frag.glsl',
					'render/gl/glsl/color_sdf.vert.glsl',
					'render/gl/glsl/color_mask_sdf.frag.glsl',
					'render/gl/glsl/color_mask_sdf.vert.glsl',
					'render/gl/glsl/image_normal.frag.glsl',
					'render/gl/glsl/image_normal.vert.glsl',
					'render/gl/glsl/image_yuv420p.frag.glsl',
					'render/gl/glsl/image_yuv420p.vert.glsl',
					'render/gl/glsl/image_yuv420sp.frag.glsl',
					'render/gl/glsl/image_yuv420sp.vert.glsl',
					'render/gl/glsl/image_sdf.frag.glsl',
					'render/gl/glsl/image_sdf.vert.glsl',
				],
				'outputs': [
