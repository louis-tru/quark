		...
		'conditions': [
			['use_gl==1', { # use opengl
				...
				'sources': [
					...
					'render/gl/gl_command.h',
					'render/gl/gl_command.cc',
		...
		'actions': [
			...
			},
			{
				...
				'inputs': [
					...
					'render/shader/_capa.glsl',
					'render/shader/capa.glsl',
					# 'render/shader/capa_prepare.glsl',
					# 'render/shader/capa_bin.glsl',
					# 'render/shader/capa_tile.glsl',
					# 'render/shader/capa_resolve.glsl',
					'render/shader/color_batch.glsl',
					'render/shader/color.glsl',
					'render/shader/clear.glsl',
					'render/shader/color_gradient.glsl',
					'render/shader/color_rrect_blur.glsl',
					'render/shader/image.glsl',
