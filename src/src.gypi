		...
		'actions': [
			...
			},
			{
				...
				'inputs': [
					...
					'render/gl/glsl/clear.frag.glsl',
					'render/gl/glsl/clear.vert.glsl',
					'render/gl/glsl/clip.frag.glsl',
					'render/gl/glsl/clip.vert.glsl',
					'render/gl/glsl/color.frag.glsl',
					'render/gl/glsl/color.vert.glsl',
					'render/gl/glsl/dotted.frag.glsl',
					'render/gl/glsl/dotted.vert.glsl',
					'render/gl/glsl/gradient.frag.glsl',
					'render/gl/glsl/gradient.vert.glsl',
					'render/gl/glsl/image_mask.frag.glsl',
					'render/gl/glsl/image_mask.vert.glsl',
					'render/gl/glsl/image.frag.glsl',
					'render/gl/glsl/image.vert.glsl',
					'render/gl/glsl/radial.frag.glsl',
					'render/gl/glsl/radial.vert.glsl',
					'render/gl/glsl/yuv420p.frag.glsl',
					'render/gl/glsl/yuv420p.vert.glsl',
					'render/gl/glsl/yuv420sp.frag.glsl',
					'render/gl/glsl/yuv420sp.vert.glsl',
				],
				'outputs': [
