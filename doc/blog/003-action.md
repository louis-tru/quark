...
[View.action]做为[View]的一个属性可接收多种类型的参数，之前给大家展示的例子中创建动作是很繁琐的，但`active`提供多种类型的参数类型的支持，包括`json`数据与`Action`对像实例本身。前面的例子中已介绍过`Action`方式，下面着重说`json`数据方法。大家也可研读`noug.js`与`action.js`中的源代码，其它[View.action]属性只是做简单的调用转发，功能的实现其实是在`action.js`文件中的`create()`方法里实现的。
...
[Action]: https://noug.cc/doc/action.html#class-action
[GroupAction]: https://noug.cc/doc/action.html#class-groupaction
[SpawnAction]: https://noug.cc/doc/action.html#class-spawnaction
[SequenceAction]: https://noug.cc/doc/action.html#class-sequenceaction
[KeyframeAction]: https://noug.cc/doc/action.html#class-keyframeaction
[Frame]: https://noug.cc/doc/action.html#class-frame
[View]: https://noug.cc/doc/noug.html#class-view
[Div]: https://noug.cc/doc/noug.html#class-div
[View.action]: https://noug.cc/doc/noug.html#set-view-action
[View.transition()]: https://noug.cc/doc/noug.html#view-transition-style-delay-cb-