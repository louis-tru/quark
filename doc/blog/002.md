...
用它来描述屏幕上所有可见的元素,它是所有视图的基础类型它也是事件的响应者，这些事件由硬件以及操作系统触发。详细的API文档讲大家去[`这里`](http://ngui.fun/doc/ngui.html#class-view)查阅。
...
在`ngui`中[Div]并没有自己单独的浮动方式这个属性。但[Div]能设置它的`contentAlign`对它的内容对齐方式做出更改，这个属性可选的值有4个，默认为`left`左对齐
...
[View]: http://ngui.fun/doc/ngui.html#class-view
[TextFont]: http://ngui.fun/doc/ngui.html#class-textfont
[TextLayout]: http://ngui.fun/doc/ngui.html#class-textlayout
[View]: http://ngui.fun/doc/ngui.html#class-view
[Sprite]: http://ngui.fun/doc/ngui.html#class-sprite
[Layout]: http://ngui.fun/doc/ngui.html#class-layout
[Span]: http://ngui.fun/doc/ngui.html#class-span
[Box]: http://ngui.fun/doc/ngui.html#class-box
[Div]: http://ngui.fun/doc/ngui.html#class-div
[Hybrid]:  http://ngui.fun/doc/ngui.html#class-hybrid
[Limit]:  http://ngui.fun/doc/ngui.html#class-limit
[Indep]:  http://ngui.fun/doc/ngui.html#class-indep
[LimitIndep]:  http://ngui.fun/doc/ngui.html#class-limitindep
[Image]:  http://ngui.fun/doc/ngui.html#class-image
[Panel]:  http://ngui.fun/doc/ngui.html#class-panel
[Root]:  http://ngui.fun/doc/ngui.html#class-root
[BasicScroll]: http://ngui.fun/doc/ngui.html#class-basicscroll
[Scroll]: http://ngui.fun/doc/ngui.html#class-scroll
[Button]: http://ngui.fun/doc/ngui.html#class-button
[Text]: http://ngui.fun/doc/ngui.html#class-text
[Input]: http://ngui.fun/doc/ngui.html#class-input
[Textarea]: http://ngui.fun/doc/ngui.html#class-textarea
[TextNode]: http://ngui.fun/doc/ngui.html#class-textnode
[Label]: http://ngui.fun/doc/ngui.html#class-label
[Video]: http://ngui.fun/doc/media.html#class-video
[Shadow]: http://ngui.fun/doc/ngui.html#class-shadow
[Trap in Layout]: http://ngui.fun/doc/ngui.html#trap-in-layout
