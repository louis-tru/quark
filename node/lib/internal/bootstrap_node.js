  ...
  function startup() {
    ...
    if (NativeModule.exists('_third_party_main')) {
      ...
      if (process._eval != null && !process._forceRepl) {
        ...
        const internal_pkg = NativeModule.require('internal/pkg');
        process.argv[1] = internal_pkg.resolveMainPath(process.argv[1]);
        ...
        if (process._syntax_check_only != null) {
          ...
          var source = internal_pkg.readFileSync(filename, 'utf-8');
